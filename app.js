...
(function () {
  ...
  var SERVICES = [
    { t: L("Onboarding on autopilot", "Onboarding auf Autopilot"), d: L("Every new client gets the same smooth start. The intake form, the welcome email, the contract, the first call — all set up without you doing it each time.", "Jeder neue Kunde bekommt denselben reibungslosen Start. Aufnahmeformular, Willkommens-E-Mail, Vertrag, das erste Gespräch — alles vorbereitet, ohne dass Sie es jedes Mal selbst tun."), i: ["M4 7h16M4 12h16M4 17h10"] },
    { t: L("24/7 answers for your clients", "24/7-Antworten für Ihre Kunden"), d: L("Your clients get answers when they need them, even when you're offline. Common questions, your method, your tone — handled for you.", "Ihre Kunden bekommen Antworten, wenn sie sie brauchen, auch wenn Sie offline sind. Häufige Fragen, Ihre Methode, Ihr Ton — für Sie erledigt."), i: ["M12 3a4 4 0 014 4v1a4 4 0 01-8 0V7a4 4 0 014-4z","M5 21v-1a7 7 0 0114 0v1"] },
    { t: L("Content from your calls and notes", "Content aus Ihren Calls und Notizen"), d: L("Your calls, voice notes and ideas become ready-to-post content. Stay visible without writing every day.", "Aus Ihren Calls, Sprachnotizen und Ideen entsteht fertiger Content. Sichtbar bleiben, ohne jeden Tag selbst zu schreiben."), i: ["M4 4h16v12H4z","M8 20h8M12 16v4"] },
    { t: L("Follow-ups that don't slip", "Follow-ups, die nicht verloren gehen"), d: L("No client gets forgotten. Check-ins, next steps and renewals are remembered for you, so every client feels seen.", "Kein Kunde wird vergessen. Check-ins, nächste Schritte und Verlängerungen werden für Sie im Auge behalten, damit sich jeder Kunde gesehen fühlt."), i: ["M4 12l5 5L20 6"] },
    { t: L("Leads handled for you", "Leads, die für Sie erledigt werden"), d: L("New enquiries get a personal reply within minutes, get qualified, and stay warm — without you watching the inbox.", "Neue Anfragen bekommen innerhalb von Minuten eine persönliche Antwort, werden qualifiziert und bleiben warm — ohne dass Sie das Postfach im Auge behalten."), i: ["M3 12l18-7-7 18-3-7-8-4z"] },
    { t: L("Daily admin that runs itself", "Tagesgeschäft, das von selbst läuft"), d: L("The repetitive stuff — scheduling, reminders, invoicing follow-ups, status updates — handled in the background, so your day is for the work that matters.", "Das Wiederkehrende — Terminplanung, Erinnerungen, Rechnungs-Nachfassen, Status-Updates — läuft im Hintergrund, damit Ihr Tag für die Arbeit ist, die zählt."), i: ["M12 3v4M12 17v4M3 12h4M17 12h4","M12 9a3 3 0 100 6 3 3 0 000-6z"] }
  ];
