...
(function () {
  ...
  var T = {
    ...
    ctaHead:   L("There's a way out of the daily grind.", "Es gibt einen Ausweg aus dem täglichen Hamsterrad."),
  ...
  var SERVICES = [
    { t: L("Onboarding on autopilot", "Onboarding auf Autopilot"), d: L("Intake form, welcome email, contract, first call — all set up the same way for every new client, without you touching it.", "Aufnahmeformular, Willkommens-E-Mail, Vertrag, erstes Gespräch — bei jedem neuen Kunden gleich, ohne dass Sie es selbst tun."), i: ["M4 7h16M4 12h16M4 17h10"] },
    { t: L("24/7 answers for your clients", "24/7-Antworten für Ihre Kunden"), d: L("Your clients get answers any time, in your voice. Common questions handled for you, around the clock.", "Ihre Kunden bekommen jederzeit Antworten in Ihrer Stimme. Häufige Fragen rund um die Uhr für Sie erledigt."), i: ["M12 3a4 4 0 014 4v1a4 4 0 01-8 0V7a4 4 0 014-4z","M5 21v-1a7 7 0 0114 0v1"] },
    { t: L("Content from your calls and notes", "Content aus Ihren Calls und Notizen"), d: L("Your calls and voice notes become ready-to-post content. Stay visible without writing every day.", "Aus Ihren Calls und Sprachnotizen entsteht fertiger Content. Sichtbar bleiben, ohne jeden Tag zu schreiben."), i: ["M4 4h16v12H4z","M8 20h8M12 16v4"] },
    { t: L("Follow-ups that don't slip", "Follow-ups, die nicht verloren gehen"), d: L("Check-ins, next steps and renewals are remembered for you. No client falls through.", "Check-ins, nächste Schritte und Verlängerungen werden für Sie im Blick gehalten. Kein Kunde geht verloren."), i: ["M4 12l5 5L20 6"] },
    { t: L("Leads handled for you", "Leads, die für Sie erledigt werden"), d: L("Every new enquiry gets a personal reply within minutes, gets qualified, and stays warm — without you watching the inbox.", "Jede neue Anfrage bekommt in Minuten eine persönliche Antwort, wird qualifiziert und bleibt warm — ohne dass Sie das Postfach beobachten."), i: ["M3 12l18-7-7 18-3-7-8-4z"] },
    { t: L("Daily admin that runs itself", "Tagesgeschäft, das von selbst läuft"), d: L("Scheduling, reminders, invoice nudges, status updates — handled in the background, so your day is for the work that matters.", "Terminplanung, Erinnerungen, Rechnungs-Nachfassen, Status-Updates — laufen im Hintergrund, damit Ihr Tag für die wichtige Arbeit bleibt."), i: ["M12 3v4M12 17v4M3 12h4M17 12h4","M12 9a3 3 0 100 6 3 3 0 000-6z"] }
  ];
